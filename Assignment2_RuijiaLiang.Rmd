...
```{r lnRR effect size}
data <- metafor::escalc(measure = "ROM", m1i=oa.mean, m2i=ctrl.mean, sd1i=oa.sd, sd2i=ctrl.sd, n1i=oa.n, n2i=ctrl.n, data = data, var.names = c("LRR","LRR_var"))
...
```{r model}
model1 <- metafor::rma.mv(yi = LRR, V = LRR_var, random=list(~1|Study, ~1|residual), test = "t", dfs = "contain", data=data)
summary(model1)
```



# Findings and forest plot
